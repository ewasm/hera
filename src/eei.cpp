...
namespace hera {
  ...
  {
    ensureCondition(!exeeds_128bits(src), ArgumentOutOfRange, "Account balance (or transaction value) exceeds 128 bits.");
  ...
  {
    ensureCondition(!exeeds_128bits(value), ArgumentOutOfRange, "Account balance (or transaction value) exceeds 128 bits.");
